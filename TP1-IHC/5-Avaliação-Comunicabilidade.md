...
## 🎯 Introdução
A Avaliação de Comunicabilidade (AC) foi aplicada após os testes de usabilidade com 8 participantes.  
O objetivo foi identificar **falhas de comunicação entre sistema e usuário**, classificando as dificuldades segundo as etiquetas propostas por Clarisse de Souza.  
